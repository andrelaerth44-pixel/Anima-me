...
enum class Engine { TOONZ_RASTER, FULL_COLOR_MYPAINT, VECTOR }
...
object BrushCatalog {
    val presets: List<BrushPreset> = listOf(
        ...
        BrushPreset("aotz-clouds", "AOTz Clouds", "AOTz", Engine.FULL_COLOR_MYPAINT, "aotz"),
        BrushPreset("aotz-water", "AOTz Water", "AOTz", Engine.FULL_COLOR_MYPAINT, "aotz"),
        BrushPreset("aotz-grass", "AOTz Grass", "AOTz", Engine.FULL_COLOR_MYPAINT, "aotz"),
        BrushPreset("aotz-leaves", "AOTz Leaves", "AOTz", Engine.FULL_COLOR_MYPAINT, "aotz"),
        BrushPreset("aotz-fur", "AOTz Fur", "AOTz", Engine.FULL_COLOR_MYPAINT, "aotz"),
    ...
    val families: List<String> = listOf("Core", "AOTz", "Classic", "Experimental", "Deevad", "Ramon", "Tanda", "Kaerhon", "Mojo", "SLOS")
}
