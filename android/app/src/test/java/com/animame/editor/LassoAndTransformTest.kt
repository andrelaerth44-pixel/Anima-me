...
class LassoAndTransformTest {
 @Test fun lassoProducesNormalizedClosedPolygon(){
  val p=LassoEngine.normalize(listOf(PointF(0f,0f),PointF(100f,0f),PointF(100f,100f),PointF(0f,100f)))
  assertTrue(p.size >= 4)
 ...
 @Test fun lassoContainsInteriorAndRejectsExterior(){
  val p=listOf(PointF(0f,0f),PointF(100f,0f),PointF(100f,100f),PointF(0f,100f))
  assertTrue(LassoEngine.contains(p,PointF(50f,50f)))
  assertTrue(!LassoEngine.contains(p,PointF(150f,50f)))
 }
